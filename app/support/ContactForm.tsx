  ...
  return (
    <form className="grid gap-4" onSubmit={submit} noValidate>
      ...
      <button
        type="submit"
        disabled={submitting}
        className="mt-2 inline-flex w-full items-center justify-center gap-2 bg-brand-primary px-6 py-4 text-base font-extrabold text-white transition-colors hover:bg-brand-primaryDim disabled:cursor-not-allowed disabled:opacity-60"
      >
